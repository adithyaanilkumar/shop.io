...
ALLOWED_HOSTS = ['*'] ##mshould be changed when the host becomes a permenant IP/URL
...
INSTANCE_CONNECTION_NAME = 'garden-fth:asia-south1:garden-db'
DATABASES = {
    'default': {
...
EMAIL_HOST_USER = 'nill@gmail.com'
EMAIL_HOST_PASSWORD = 'nill@1968'
EMAIL_USE_SSL = True
...
if os.getenv('ENV')!='PROD':
    from garden_drf.dev_settings import *

import sentry_sdk
from sentry_sdk.integrations.django import DjangoIntegration

sentry_sdk.init(
    dsn="https://40582a5b4ac5440088134687f7051b80@o431838.ingest.sentry.io/5383697",
